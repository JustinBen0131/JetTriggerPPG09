...
//  -*- C++ -*-.
#ifndef JETTRIGGERPLOTTER_H
#define JETTRIGGERPLOTTER_H
...
class JetTriggerPlotter : public SubsysReco{
public:
    
    // A constructor that takes two std::string arguments
    JetTriggerPlotter(const std::string &dataOutFile = "caloTreeData.root");
    
    ~JetTriggerPlotter() override;
