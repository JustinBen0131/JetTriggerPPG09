...
//____________________________________________________________________________..
JetTriggerPlotter::~JetTriggerPlotter() {
    std::cout << "[DEBUG] JetTriggerPlotter::~JetTriggerPlotter() destructor called." << std::endl;
}

//____________________________________________________________________________..
int JetTriggerPlotter::Init(PHCompositeNode* /*topNode*/) {
    if (verbose) {
        std::cout << ANSI_COLOR_BLUE_BOLD << "Initializing JetTriggerPlotter -- RUNNING Init" << ANSI_COLOR_RESET << std::endl;
    }
...
//____________________________________________________________________________..
void JetTriggerPlotter::createHistos_Data() {
    std::cout << "[DEBUG] Entering JetTriggerPlotter::createHistos()..." << std::endl;
...
//____________________________________________________________________________..
int JetTriggerPlotter::process_event(PHCompositeNode *topNode)
{
    event_count++;

    std::cout << "\n========== Processing JetTriggerPlotter -- Event " << event_count << " ==========\n";
    ...
    {
        std::cerr << "[ERROR] No JetTriggerPlotter pointer!\n";
...
//____________________________________________________________________________
void JetTriggerPlotter::checkMbdAndFillNewHists(
...
int JetTriggerPlotter::ResetEvent(PHCompositeNode* /*topNode*/)
{
...
//____________________________________________________________________________
int JetTriggerPlotter::End(PHCompositeNode* /*topNode*/)
{
    if (verbose)
    {
        std::cout << ANSI_COLOR_BLUE_BOLD
                  << "JetTriggerPlotter::End() – finishing up and writing histograms"
                  << ANSI_COLOR_RESET << std::endl;
    }
    ...
    if (verbose)
    {
        std::cout << ANSI_COLOR_GREEN_BOLD
                  << "JetTriggerPlotter::End() completed successfully."
                  << ANSI_COLOR_RESET << std::endl;
    }
    return Fun4AllReturnCodes::EVENT_OK;
}
...
//____________________________________________________________________________..
int JetTriggerPlotter::Reset(PHCompositeNode* /*topNode*/) {
 std::cout << "JetTriggerPlotter::Reset(PHCompositeNode *topNode) being Reset" << std::endl;
  return Fun4AllReturnCodes::EVENT_OK;
}

//____________________________________________________________________________..
void JetTriggerPlotter::Print(const std::string &what) const {
  std::cout << "JetTriggerPlotter::Print(const std::string &what) const Printing info for " << what << std::endl;
}
